...
from app.views import auth_blueprint, accounts_blueprint, notify_blueprint, services_blueprint
...
# Register blueprints
BLUEPRINTS = [auth_blueprint, accounts_blueprint, notify_blueprint, services_blueprint]
